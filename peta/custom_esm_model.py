...
if __name__ == "__main__":
    model = DebertForSequenceClassification.from_pretrained("AI4Protein/prime_turbo", pooling_head="attention1d", num_labels=1, is_ppi=False)
    tokenizer = AutoTokenizer.from_pretrained("AI4Protein/prime_turbo")
    sequences = [
